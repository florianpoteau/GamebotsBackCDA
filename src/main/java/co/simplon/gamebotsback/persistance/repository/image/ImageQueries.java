...
public class ImageQueries {
    ...
    public static final String FIND_ALL_IMAGES_BY_GAMEID = "SELECT i FROM Image i JOIN i.typeImage ti JOIN i.game g WHERE ti.name = :typeImage AND g.idGame = :gameId";
}
